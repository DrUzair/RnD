...
## Predicting city mpg (variable “UCity” in column BG). {.tabset .tabset-fade .tabset-pills}

EDA led the choice of variables and models. [Ref](https://rpubs.com/uzair/fueleco)
...
rf_reg <- train(UCity~., data=vhcls_data_complete, method="rf", metric="RMSE", tuneGrid=tunegrid, trControl=control)
